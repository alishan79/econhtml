<body style="padding:0px; margin:0px; background-color:#fff;font-family:Arial, sans-serif" >
    ...
    <style>
		...
		.jssort11 .t, .jssort11 .pav:hover .t {    position: absolute;    top: 8px;    left: 70px;    width: 122px;    height: 32px;    line-height: 32px;    text-align: left;    color: #fff;    font-size: 12px; }<!--@Ali Shan thubmail caption-->
