...
<body style="padding:0px; margin:0px; background-color:#fff;font-family:Arial, sans-serif">
    ...
    <style>
        ...
        */
		...
		.jssort11 .i, .jssort11 .pav:hover .i {    position: absolute;    top: 3px;    left: 3px;    width: 195px;    height: 63px;    border: white 1px solid;}* html <!--@Ali Shan thubmnail image size--!>
		.jssort11 .i {    width /**/: 62px;    height /**/: 32px;}
		.jssort11 .pav .i {    border: white 1px solid;}
		.jssort11 .t, .jssort11 .pav:hover .t {    position: absolute;    top: 8px;    left: 40px;    width: 129px;    height: 32px;    line-height: 32px;    text-align: center;    color: #fff;    font-size: 13px;    font-weight: 700;}<!--@Ali Shan thubmail caption-->
		...
		.jssort11 .p:hover, .jssort11 .pav:hover {    background: #999;}
		.jssort11 .pav, .jssort11 .p.pdn {    background: #666;}
        
    </style>
    <div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 1000px; height: 300px; overflow: hidden; visibility: hidden; background-color: #000000;"> <!--@AliShan dimensions changes-->
        <!-- Loading Screen -->
        <div data-u="loading" style="position: absolute; top: 0px; left: 0px;">
            <div style="filter: alpha(opacity=70); opacity: 0.7; position: absolute; display: block; top: 0px; left: 0px; width: 100%; height: 100%;"></div>
            <div style="position:absolute;display:block;background:url('img/loading.gif') no-repeat center center;top:0px;left:0px;width:100%;height:100%;"></div>
        </div>
        <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 794px; height: 300px; overflow: hidden;"> <!--@AliShan images dimensions changes-->
