<body style="padding:0px; margin:0px; background-color:#fff;font-family:Arial, sans-serif" >
    ...
    <style>
		...
		.textup{font-size:14px; color:#FFFFFF;}
		body{color:#f2f2f2;}
    </style>
...
-webkit-box-shadow: 0px 0px 10px 1px rgba(189, 185, 185, 0.75);"> <!--@AliShan dimensions changes-->
        ...
        <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 752px; height: 260px; overflow: hidden;"> <!--@AliShan images dimensions changes-->
            <div data-p="112.50" style="display: none;">
            	    ...
            	    <img data-u="image" src="img/bn1.png" usemap="#Map"/>
					<map name="Map" id="Map"><area shape="rect" coords="30,200,140,230" href="index.php" title="Home Page"/>
					</map>
            ...
            <div data-p="112.50" style="display: none;">
                <img data-u="image" src="img/bn2.png" usemap="#Map2"/>
				 <map name="Map2" id="Map2">
					<area shape="rect" coords="29,220,137,250" href="http://www.creb.org.pk/" target="_blank" title="CREB"/>
					<area shape="rect" coords="145,220,253,250" href="http://www.gids.org.pk/" target="_blank" title="GIDS" />
					<area shape="rect" coords="261,220,372,250" href="tmicmain.php" target="_blank" title="TMIC" />
				</map>
                <div data-u="thumb">
            ...
            <div data-p="112.50" style="display: none;">
                <img data-u="image" src="img/bn3.png" usemap="#Map3" />
				<map name="Map3" id="Map3">
					<area shape="rect" coords="29,200,190,230" href="ug_degrees.php" title="Undergraduate Programs"/>
					<area shape="rect" coords="195,200,360,230" href="postgrad_degrees.php" title="Post-Graduate Programs" />
				</map>
                <div data-u="thumb">
        ...
        <map name="Map" id="Map"><area shape="rect" coords="63,120,734,255" href="http://www.yahoo.com" target="_blank"  title="Click Me"/></map>
        </div>
        <!-- Thumbnail Navigator -->
