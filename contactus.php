...
{
	$email ='ayeshakh@lahoreschool.edu.pk';// <<=== update to your email address
...
?>
	...
	<div class="leftmenuContainer">	
		...
		<ul>
			...
			<li><a href="findus.php">Finding Us</a></li>			
		</ul>
    ...
    <tr>
      <td>
	  <h5>Department of Economics</h5>

	  <p>
	  <br>
	  <b>Address:</b> Lahore School of Economics, Intersection Main Boulevard Phase VI DHA, Burki Road Lahore 53200, Pakistan.<br><br>
<b>Phone:</b> +92 42 36560969<br><br>
<b>Fax:</b> +92 42 36560905<br><br>
<b>Contact Person:</b> Ms. Ayesha Khanum <br><br>
<b>Email:</b> ayeshakh@lahoreschool.edu.pk <br><br>
