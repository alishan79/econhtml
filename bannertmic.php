...
-webkit-box-shadow: 0px 0px 10px 1px rgba(189, 185, 185, 0.75);"> <!--@AliShan dimensions changes-->
        ...
        <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 752px; height: 260px; overflow: hidden;"> <!--@AliShan images dimensions changes-->
            <div data-p="112.50" style="display: none;">
            	    ...
            	    <img data-u="image" src="img/tmic1.png" />
				
                <div data-u="thumb">
                    <img class="i" src="img/tmic1_thumb.png" />
                    <div class="t">Innovation and Technology Centre</div>
                    <div class="c"></div>
                </div>
				
            </div>
            <div data-p="112.50" style="display: none;">
                <img data-u="image" src="img/tmic2.png" />
                <div data-u="thumb">
                    <img class="i" src="img/tmic2_thumb.png" />
                    <div class="t">Research Agenda</div>
                    <div class="c"></div>
                </div>
            </div>
            <a data-u="any" href="http://www.jssor.com" style="display:none">List Slider</a>
            <div data-p="112.50" style="display: none;">
                <img data-u="image" src="img/tmic3.png" />
				 
                <div data-u="thumb">
                    <img class="i" src="img/tmic3_thumb.png" />
                    <div class="t">Major Research Projects</div>
                    <div class="c"></div>
                </div>
            </div>
